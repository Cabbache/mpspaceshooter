...
pub enum ClientMessage{
	Ping,
	AckPong,
	PropelUpdate {on: bool, at: String},
	Rotation {dir: i8, at: String},
	ChangeSlot {slot: u8},
...
pub enum ServerMessage{
	...
	PropelUpdate { propel: bool, at: String, from: String },
	RotationUpdate { direction: i8, at: String, from: String },
